#!/usr/bin/env python3
"""
Extract ABI data from Foundry artifacts.

This script reads all JSON files from a Foundry artifacts directory,
extracts the 'abi' key from each file, and writes it to the output directory.

Usage:
    python3 from_foundry.py [artifacts-dir] [output-dir]

Example:
    python3 from_foundry.py /home/pyk/codearena/2025-10-covenant/out fixtures/abi/covenant
"""
